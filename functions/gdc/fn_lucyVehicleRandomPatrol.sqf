...
Parameters:
	...
	_wpPosParams - parameters for waypoint position, see BIS_fnc_findSafePos [ARRAY, defaults to [10,100,10,0]]
...
if (_safePos) then {
	...
	_randomPos = [[_markerZone], _blacklist] call BIS_fnc_randomPos;
};
